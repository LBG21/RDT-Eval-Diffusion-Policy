...
class HDF5VLADataset:
    ...
    def __init__(self):
        ...
        self.data_dir = "/data/bangguo/ManiSkill/demo_1k/"
    ...
    def parse_hdf5_file(self, index):
        ...
        return True, {
            'obs':
            {
                'agent_pos': torch.tensor(state, dtype=torch.float32),
                'head_cam': torch.tensor(img_history, dtype=torch.float32).permute(0, 3, 1, 2),
            },
        ...
        #     # Assuming no wrist cameras; you can modify accordingly
